    ...
    return (
      <section className="album">
        <section id="album-info">
         ...
         <table id="song-list">
           <colgroup>
             <col id="song-number-colunm" />
             <col id="song-title-colunm" />
             <col id="song-duration-colunm" />
           </colgroup>
           <tbody>
             {this.state.album.songs.map( (song, index) =>
               <tr className="song"
                   ...
                   onMouseEnter={() => this.handleSongRowHover(index)}
                   onMouseLeave={() => this.handleSongRowHover(index)} >
